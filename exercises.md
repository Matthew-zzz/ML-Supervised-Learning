...
* Понимание механики линейной регрессии (нормальные уравнения, MSE, градиенты)
* Понимание логистической регрессии (вероятностная интерпретация, log-loss)
* Умение самостоятельно считать метрики
* Способность анализировать поведение модели, а не просто вызывать библиотеку

Базовый, профессионально корректный фундамент supervised learning:
регрессия, классификация и количественная оценка качества модели.
